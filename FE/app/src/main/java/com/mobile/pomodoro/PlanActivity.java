...
import com.mobile.pomodoro.repository.UserRepository;
...
//            Lấy title
        ...
        // lưu plan theo user, nên phải thêm header là username vào
        UserRepository userRepo = UserRepository.getInstance(this);
